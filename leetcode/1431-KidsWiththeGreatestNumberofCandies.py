...
'''
# Runtime: 28 ms,    faster than 98.87% of Python3 online submissions for Kids With the Greatest Number of Candies.
# Memory Usage: 14 MB, less than 93.97% of Python3 online submissions for Kids With the Greatest Number of Candies.
class Solution:
