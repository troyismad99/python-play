...
# Runtime:      43 ms, faster than 42.70% of Python3 online submissions for Sum of Digits of String After Convert.
# Memory Usage: 14.2 MB, less than 82.75% of Python3 online submissions for Sum of Digits of String After Convert.
